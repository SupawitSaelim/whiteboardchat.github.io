...
btnEraser.addEventListener('click', () => {
    ...
    }, 100); // 100 มิลลิวินาทีหลังจากเคลียร์หน้าจอ
});
...
const sendClearCanvasData = () => {
    const clearData = {
        action: 'clear-canvas',
    };
    updateDocument(clearData, 'clear-canvas');
                ...
                if (!event.isLocal) {
                    switch (event.data.action) {
                        ...
                        case 'start-timer':
                            ...
                            break;
                        case 'clear-canvas':
                            clearCanvas(); // เพิ่มการเรียกใช้ clearCanvas เพื่อลบแผนภาพ
                            break;
                        default:
                            break;
                    }
